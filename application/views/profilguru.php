          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary" >
              <div class="card-header bg-success">
                <h3 class="card-title">Lihat Profil Data Guru</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm">
                <div class="card-body">
                  <div class="form-group">
                    <label>NIK</label>
                    <input type="nik" name="nik" class="form-control" id="">
                  </div>
                  <div class="form-group">
                    <label>Nama</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="jk" name="jk" class="form-control" id="">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="nt" name="nt" class="form-control" id="">
                  </div>
                  <div class="form-group">
                    <label>Alamat</label>
                    <input type="alamat" name="alamat" class="form-control" id="">
                  </div>
                </div>
                <!-- /.card-body -->
