...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?= base_url('assets/guru/') ?>dist/css/adminlte.min.css">
</head>
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?= base_url('loging/aksi_login'); ?>" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <input type="submit" class="btn btn-primary btn-block">Login</input>
          </div>
          <!-- /.col -->
        </div>
      </form>
...
<!-- AdminLTE App -->
<script src="<?= base_url('assets/guru/') ?>dist/js/adminlte.min.js"></script>
</body>
</html>
